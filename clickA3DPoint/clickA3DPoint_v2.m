function [h,points] = clickA3DPoint(pointCloud)
%CLICKA3DPOINT
...
h = gcf;
hold on
plot3(pointCloud(1,:), pointCloud(2,:), pointCloud(3,:), 'ro','MarkerSize',0.5); 
...
set(h, 'WindowButtonDownFcn', {@callbackClickA3DPoint_v2, pointCloud}); 
